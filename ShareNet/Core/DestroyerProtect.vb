Imports ShareNet.Destroyer.AntiAnalysis
Imports ShareNet.Destroyer.AntiDebug
Imports ShareNet.Destroyer.AntiDump
Imports ShareNet.Destroyer.AntiVirtualMachine
...
#Region " Methods "
        ...
        Public Shared Sub Start(ByVal ProcessScan As MainAnalysis.SearchType, ByVal DebugScan As MainDebug.DebugDetectionTypes, _
                                ByVal VMScanType As VMScanType, Optional EnableAntiDump As Boolean = False)
            Execution_Start()
