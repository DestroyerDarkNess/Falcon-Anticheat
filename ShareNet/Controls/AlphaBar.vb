...
Class AlphaBar
    ...
    Public Property BaseColor As Color ' By Destroyer. Al creador se le olvido el color de fonde del TextBox
        Get
            Return _BaseColor
        End Get
        Set(value As Color)
    ...
    Overrides Sub PaintHook()
        G.Clear(BackColor)
        Dim brush1 As Brush = New SolidBrush(_BaseColor)
        G.FillRectangle(brush1, 0, 0, CInt((_Value / _Maxiumum) * Width), Height)
        'FromArgb(0, 223, 146)
        G.DrawRectangle(New Pen(_BaseColor), 0, 0, Width - 1, Height - 1)
    End Sub
End Class
