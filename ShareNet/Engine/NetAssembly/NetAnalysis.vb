...
Namespace Net
    ...
    Public Class NetAnalysis
        ...
        Public Shared Function NetScan(ByVal Archive As String) As Boolean
            ...
            '/////////////////////////////////
            Dim MImports As String = Net.DataBasesWrapper.GetDataA()
            Dim StrImports As String = Net.DataBasesWrapper.GetDatA()
            '/////////////////////////////////
            Dim Importaciones As String = Net.OpenAssembly.GetImports(Archive)
            '/////////////////////////////////
            ...
            '/////////////////////////////////
            Dim cClases As String = Net.DataBasesWrapper.GetDataB()
            Dim SAs As String() = cClases.Split("|")
            '/////////////////////////////////
            Dim SimbolsClases As String = Net.DataBasesWrapper.GetDatB()
            Dim SimbolsC As String() = SimbolsClases.Split(",")
            '/////////////////////////////////
            Dim Clases As String = Net.OpenAssembly.GetNameModules(Archive)
